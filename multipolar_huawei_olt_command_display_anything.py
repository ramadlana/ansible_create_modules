...
def run_module():
    ...
    # param input
    module_args = dict(
        olt_display_command = dict(type='str', required=True),
        ansible_host=dict(type='str', required=True),
        ansible_network_os=dict(type='str', required=True),
        ansible_user=dict(type='str', required=True),
        ansible_platform=dict(type='str', required=True),
        ansible_ssh_pass=dict(type='str', required=True),
    )
    ...
    proposed_args = {
            ...
            'command': module.params['olt_display_command'],
    ...
    parsed = parse_output(platform=module.params['ansible_platform'], command=module.params['olt_display_command'], data=device_cli_output)
