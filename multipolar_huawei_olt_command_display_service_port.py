...
def run_module():
    ...
    # param input
    module_args = dict(
        service_port_vlan=dict(type='str', required=False),
    ...
    proposed_args = {
            ...
            'command': "display service-port vlan " + module.params['service_port_vlan'],
    ...
    parsed = parse_output(platform=module.params['ansible_platform'], command="display service-port vlan " + module.params['service_port_vlan'], data=device_cli_output)
